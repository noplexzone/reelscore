...
export function validateConfig(env = {}) {
  ...
  if (isHosted) {
    ...
    if (rawProxy !== undefined && rawProxy !== null && rawProxy !== "" && (!Number.isInteger(Number(rawProxy)) || Number(rawProxy) < 0)) throw new Error("[reelscore] FATAL: TRUST_PROXY must be a non-negative integer.");
  }
  let previousKeys = {};
  ...
  return {
    ...
    TRUST_PROXY: rawProxy !== undefined && rawProxy !== null && rawProxy !== "" ? Number(rawProxy) : 0,
